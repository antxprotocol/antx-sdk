...
from .crypto import (
    eth_personal_sign,
    convert_to_eth_addr,
    convert_to_antex_addr,
    secp256k1_pubkey_compressed,
    derive_antex_bech32_address,
)
from .tx import (
    Signer,
    build_auth_info,
...
# Proto messages (require generated modules under python/antex_proto/**)
try:
...
class AntexClient:
    ...
    def set_credentials(self, agent_private_key_hex: str, chain_id: str, account_hrp: str = ACCOUNT_HRP) -> None:
        ...
        try:
            self._agent_address_bech32 = derive_antex_bech32_address(self._agent_priv_bytes, account_hrp)
        except Exception:
    ...
    def _ensure_account_number(self) -> None:
        ...
        # First compute raw eth-like address from pubkey (20 bytes) via convert_to_antex_addr helper if available
    ...
    def get_eth_address(self, antex_bech32_address: str) -> str:
        return convert_to_eth_addr(antex_bech32_address)
    ...
    def _sign_and_send_tx(self, type_url: str, msg, unordered: bool) -> str:
        if agent_tx is None or order_tx is None:
            raise RuntimeError("protobuf modules not available; generate python/antex_proto first")
