...
# Msg type urls
MSG_CREATE_ORDER_TYPE_URL = "/antex.chain.order.MsgCreateOrder"
MSG_CREATE_ORDER_BATCH_TYPE_URL = "/antex.chain.order.MsgCreateOrderBatch"
MSG_CANCEL_ORDER_TYPE_URL = "/antex.chain.order.MsgCancelOrder"
MSG_CANCEL_ORDER_BY_CLIENT_ID_TYPE_URL = "/antex.chain.order.MsgCancelOrderByClientId"
MSG_CANCEL_ALL_ORDER_TYPE_URL = "/antex.chain.order.MsgCancelAllOrder"
MSG_CLOSE_ALL_POSITION_TYPE_URL = "/antex.chain.order.MsgCloseAllPosition"

MSG_BIND_AGENT_TYPE_URL = "/antex.chain.agent.MsgBindAgent"
