...
# Expect these modules to be generated into python/antx_proto/**
# Try importing cosmos proto, fallback to None if not available
try:
    from antx_proto.cosmos.tx.v1beta1.tx_pb2 import TxBody, AuthInfo, TxRaw, SignDoc
    from antx_proto.cosmos.tx.signing.v1beta1.signing_pb2 import SignMode
    from antx_proto.cosmos.base.v1beta1.coin_pb2 import Coin
    from antx_proto.cosmos.crypto.secp256k1.keys_pb2 import PubKey as Secp256k1PubKey
    from antx_proto.cosmos.tx.v1beta1.tx_pb2 import SignerInfo, ModeInfo, Fee
